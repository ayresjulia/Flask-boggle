...
class Boggle():
    ...
    def __init__(self):
        ...
        self.words = self.read_dict("words.txt")  # read words text file

    def read_dict(self, dict_path):
        """Read and return all words in dictionary."""

        dict_file = open(dict_path)  # get access to words file
        words = [w.strip() for w in dict_file]  # get only words from txt file
        dict_file.close()  # close txt file
        return words  # gets a list of all words in a file ['a','b'...]
    ...
    def make_board(self):
        ...
        for y in range(5):
            # ascii_uppercase returns all uppercase letters in a str
    ...
    def check_valid_word(self, board, word):
        ...
        word_exists = word in self.words  # if word is in a list of words from words.txt
        # upperrcase word should be in the board
